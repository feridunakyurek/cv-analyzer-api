...
public class CvUploadController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<CvUpload> uploadCv(@RequestParam("file") MultipartFile file, Authentication authentication) throws UserNotFoundException {
        ...
        return ResponseEntity.ok(cvUpload);
    }
